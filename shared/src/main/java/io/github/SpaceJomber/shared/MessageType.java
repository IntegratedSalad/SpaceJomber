...
public enum MessageType {
    ...
    MSG_SERVER_SENDS_SESSION_ID(6), // accept player
    MSG_SERVER_DENIES_ENTRY(7),
    MSG_SERVER_LOBBY_DOESNT_EXIST(8),
    MSG_SERVER_TERMINATE_CONNECTION(9),
    MSG_SERVER_STARTS_SESSION(10),
